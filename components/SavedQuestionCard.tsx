          ...
          <div className="relative w-full max-w-3xl max-h-full px-10 py-10 mx-auto overflow-y-auto text-black bg-white rounded-lg shadow-2xl 2xl:max-w-5xl">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="w-full">
                ...
                <label
                  htmlFor="file"
                  className="flex flex-col items-center justify-center w-full p-6 mb-8 border rounded-md cursor-pointer"
                >
                  {!image?.file ? (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div>
                      ...
                      <img className="h-40" src={image?.url} alt="image" />
                    </div>
                  )}
                  <div>
                    {!image?.file && (
                  ...
                  <h5 className="text-sm font-semibold">{image?.file?.name}</h5>
                </label>
              </div>
